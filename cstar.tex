...
\end{point}
\begin{point}{Definition (Gelfand--Naimark--Segal construction)}%
	\\
...
$\eta\colon \scrA\to\scrH_\omega$
with $\left<\eta(a),\eta(b)\right>= [a,b]_\omega$ for all~$a,b\in \scrA$,
but instead of using it,
we will, given $a\in \scrA$,
 denote the element $\eta(a)$ of~$\scrH_\omega$ simply by~$a$ 
...
\begin{point}{Exercise}%
Show that $a\mapsto \varrho_\omega(a)$ gives a miu-map 
$\Define{\varrho_\omega}\colon \scrA\to\mathscr{B}(\scrH_\omega)$.
(Hint: 
