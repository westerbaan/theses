...
is injective provided that, for all~$a\in \pos{\scrA}$,
\begin{equation}
...
\begin{point}{Proof}%
Suppose that~\ref{gelfand-naimark-representation-injective}
...
(because $a^*a=0$ implies $a=0$).
Since~$\varrho_\Omega(a)=0$,
we have $\varrho_\omega(a)=0$

Note that~$\varrho_\Omega(a)=0$
