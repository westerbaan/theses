...
when endowed with the operator norm.
The multiplication is given by composition,
...
(We'll see later on that every $C^*$-algebra
is isomorphic to a $C^*$-algebra
of bounded operators.)

\TODO{refer to an appendix on Hilbert space}
\end{point}
\begin{point}{Example}%
