...
\end{point}
\begin{point}{70}[cstar-product-2]{Exercise}%
...
\end{point}
\begin{point}{80}[cstar-equaliser-1]{Exercise}%
...
\end{point}
\begin{point}{70}{Exercise (Gelfand--Mazur's Theorem for $C^*$-algebras)}%
...
\end{parsec}
\begin{parsec}{180}%
\begin{point}{10}[cstar-product-3]{Exercise}%
...
\end{parsec}
\begin{parsec}{190}
\begin{point}{10}[prod-spec]{Lemma}%
...
\end{point}
\end{point}
\begin{point}{50}[norm-mi-map]{Exercise}%
...
\index{Russo--Dye's Theorem!for completely positive maps}
$\|f\|= \|f(1)\|$
