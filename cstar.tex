...
Completely maps are often touted as 
a good model for quantum processes
(over plain positive maps)
with an argument involving the tensor product.
We found that the absense of the lemmas \sref{cp-cs} and~\sref{choi}
for positive maps already 
make cp-maps indispensable,
long before the tensor product properly comes into play.
\end{point}
