...
Let~$T\colon \scrH\to \scrK$ be a bounded linear map
between Hilbert spaces.
Show that there is a unique bounded linear 
map~$\Define{T^*}\colon \scrK\to\scrH$
called the \Define{adjoint} of~$T$ with
$\left<T^*x,y\right>=\left<x,Ty\right>$
for all~$x,y\in\scrH$.
\end{point}
\end{parsec}
