...
\end{point}
\end{point}
\begin{point}{Lemma (``p$\Rightarrow$i'')}\label{cstar-p-implies-i}%
...
\end{equation*}
Nevertheless, we will see in~\sref{cp-isometry} that 
such a bipositive map~$f$ is an isometry (on all of~$\scrA$)
provided that~$f$ is completely positive.
\end{point}
\end{point}
\end{parsec}
\begin{parsec}%
