...
\NewDocumentEnvironment{point}{o g}{%
	...
	\ifthenelse{\equal{\value{point}}{0}}{}{%
		\par\penalty-100\vskip.3em\noindent%
		\marginnote{\makebox[1em][c]{%
			\textPointNumber{\Roman{point}}}}%
	}%
	\IfValueT{#2}{\ifthenelse{\equal{\value{point}}{0}}%
		{\textParsecHeader{#2}}%
		{\textPointHeader{#2}}%
	\ \ }%	
