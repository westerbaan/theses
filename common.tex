...
\newcommand{\textPointNumberI}[1]{\textcolor{lightblue}{\textsf{#1}}}
\newcommand{\textPointNumberII}[1]{\textcolor{lightgray}{\textsf{#1}}}
...
\NewDocumentEnvironment{point}{o g}{%
	...
	\IfValueT{#2}{\ifthenelse{\equal{\value{point}}{1}}%
		{\textParsecHeader{#2}}%
		{\textPointHeader{#2}}%
	\ \ }%	
}{%
