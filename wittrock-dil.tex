...
\newcommand{\leancommit}{ceed8acee03562fa064e57dfc41926e258eb020e}
...
\lean{Wittrock}{164}{IsWittrockDilationOf}%
...
\lean{WittrockSplit}{306}{wittrock_correspondence}%
...
\begin{definition}
\lean{WittrockSplit}{538}{SplitsOffCommutant}%
...
\lean{WittrockSplit}{859}{exists_typeI_factor_iso}%
...
\lean{WittrockSplit}{895}{splitsOffCommutant_of_typeI_factor}
\end{lemma}
\begin{proof}
...
\lean{WittrockSplit}{2042}{splitsOffCommutant_iff_centre_corners}%
A von Neumann subalgebra~$\mathscr{R}$
    of a von Neumann algebra~$\mathscr{P}$
...
\lean{WittrockSplit}{1752}{splitsOffCommutant_of_atomicTypeI}%
In particular,
...
\lean{WittrockBK}{1053}{splitsOffCommutant_bh_iff}%
...
\lean{WittrockSplit}{575}{splitsOffCommutant_range_iff}%
...
\lean{WittrockSplit}{831}{wittrock_iff_splitsOffCommutant}%
...
\lean{WittrockSplit}{818}{isWittrockDilationOf_of_splitsOffCommutant}%
In that case,
...
\lean{Wittrock}{1128}{isWittrockDilationOf_bh_paschke}%
...
\lean{Wittrock}{264}{isWittrockDilationOf_stdFilter}%
For example,
...
\lean{WittrockSplit}{1766}{exists_wittrockDilation_of_atomicTypeI}%
...
\lean{WittrockSplit}{983}{centre_linf_of_wittrock}%
Let~$\varrho \colon \mathscr{X} \to \mathscr{P}$
    and~$h \colon \mathscr{P} \to \mathscr{A}$
    form a Paschke dilation of an ncp-map~$\varphi \colon \mathscr{X} \to \mathscr{A}$.
...
\lean{WittrockSplit}{1345}{not_wittrock_of_centre_no_minProj}%
In particular,
...
\lean{WittrockBK}{1071}{wittrock_iff_atomicTypeI_stinespring}%
...
\lean{WittrockBK}{1096}{not_wittrock_of_factor_not_typeI}%
In particular,
