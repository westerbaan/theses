...
\end{point}
\end{point}
\begin{point}[effectus-in-partial-form]{Definition}%
...
\section{\texorpdfstring{$\dagger$-effectus}{%
                    dagger-effectus}}
\begin{parsec}%
\begin{point}[dagger-effectus]{Definition}%
