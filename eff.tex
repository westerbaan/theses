...
\subsection{More on abstract $M$-convex sets}
\begin{parsec}%
\begin{point}%
Our next project is a tangent:
    we investigate whether~$\AConvM$ is an effectus.
...
\begin{align*}
    ...
    \omega_{ij} (\kappa_1(x)) &\ =\ \rfrac{\psi_{11}(\kappa_1(x))}{\zeta_{ij}}
&& \text{for $1 \leq i \leq l$}
    \\
