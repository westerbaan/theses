...
\begin{point}%
The operation~$\andthen{a}{b} \equiv \sqrt{a}b\sqrt{a}$
    on the von Neumann algebra~$\scrB (\scrH)$
...
Gudder and coauthors establish some basic algebraic properties of~$\&$,
    which are surprisingly hard to prove.
    Then, in \cite{gudder2008characterization},
    Gudder and Latr\'emoli\`ere (G\&L)
    characterize~$\&$ as the unique operation satisfying
\begin{multicols}{2}
\begin{enumerate}
...
How do these characterization relate?
