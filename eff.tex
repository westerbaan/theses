...
\asrt_b \after \asrt_a\  =\  \asrt_{\andthen{b}{a}}
        \after \pi_{\ceil{\andthen{b}{a}}} 
        \after \mu \after \zeta_{\ceil{\andthen{a}{b}}}$.
We want to show~$\mu = \nu^{-1}$.
By~\sref{pristine-asrt}
we have
\begin{align*}
\asrt_{\andthen{b}{a}} \after \pi_{\ceil{\andthen{b}{a}}}
&\  =\  \pi_{\ceil{\andthen{b}{a}}} \after \asrt_{\andthen{b}{a} \after \pi_{\ceil{\andthen{b}{a}}}} \\
\asrt_{\andthen{a}{b}} \after \pi_{\ceil{\andthen{a}{b}}}
&\  =\  \pi_{\ceil{\andthen{a}{b}}} \after \asrt_{\andthen{a}{b} \after \pi_{\ceil{\andthen{a}{b}}}}.
\end{align*}
Combined with the second axiom of a~$\dagger'$-effectus we get
\end{point}
\end{point}
\end{parsec}
\end{document}
