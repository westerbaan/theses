...
\begin{parsec}%
\begin{point}%
We will first show that the total maps of an effectus in partial form
    are an effectus in total form.
The proof of the pullback diagrams will elucidate
    their purpose and make the proof in the opposite direction more palatable.
\end{point}
...
\end{point}
\begin{point}%
To show the square on the righy of \eqref{pullbacks} is a pullback
    in~$\Tot C$,
...
This structure is hidden in the pullback squares 
    \eqref{pullbacks}:
    the left diagram corresponds to the
        existence of~$\langle \alpha,\beta\rangle$
        and the right diagram is required for its uniqueness.\TODO{}
\end{point}
\end{parsec}
