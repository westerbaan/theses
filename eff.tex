...
\begin{parsec}%
\begin{point}%
Our next project is to show~$\AConvM$ is an effectus.
The case~$M=[0,1]$ is easier and is shown in \cite{statesofconvexsets}. 
...
\begin{parsec}%
\begin{point}{Theorem}%
    The category~$\AConvM$ is an effectus (in total form).
\begin{point}{Proof}%
