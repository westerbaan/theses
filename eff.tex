...
Prove that this turns the unit interval of~$C(X)$ into an effect divisoid.
\end{enumerate}
...
To finish, we relate the structures in a~$\dagger$-effectus
    with other structures in the literature.
We start with the~$\dagger$-structures of~$\Pure C$.
\end{point}
\begin{point}{Definition}%
