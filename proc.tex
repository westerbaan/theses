...
the matrix $(\ \beta(a_i^*a_j,b_i^*b_j)\ )_{i,j} $
is positive
...
For all von Neumann algebras~$\scrA$
and~$\scrB$ we pick a tensor product
$\Define{\otimes}\colon \scrA\times\scrB\to\Define{\scrA\otimes\scrB}$
to be the canonical tensor product of~$\scrA$ and~$\scrB$.
