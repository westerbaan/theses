...
by~\TODO{...},
because for positive $N\times N$-matrices~$A$ and~$B$
over~$\scrA$ and~$\scrB$, respectively,
we have
$(M_N\beta)(A,B)
= (M_N\otimes)(\,(M_Nf)(A),\,(M_Ng)(B)\,)
\geq 0$,
by~\TODO{...},
since~$\otimes$ being mi-bilinear is completely positive.
