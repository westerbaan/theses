...
We will prove~\sref{duplicable} in this section.
Let us give
...
is commutative (in~\sref{lem:uniqueness-duplicator}).
...
(in the proof of~\sref{duplicable}).
The measure space~$X$ splits
in a discrete~$D$ and a continuous part~$C$,
so~$X\cong D\oplus C$
(see~\sref{lem:measure-space-continuous-discrete}).
