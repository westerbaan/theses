...
but also to contrast it with
	...
	that appears in the next thesis.\REMARK{add ref.}
\end{point}
...
\begin{point}{Proof}%
Any such $\diamond$-positive map~$g\colon \scrA\to\scrA$ with~$g(g(1))=p$
will be of the form
...
the need to axiomatize all sequential products simultaneously---at
...
\end{parsec}%
\begin{parsec}%
\index{comletely positive!bilinear map}
\begin{point}%
