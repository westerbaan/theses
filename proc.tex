...
the tensor product
of Hilbert spaces 
(and also the tensor product of von Neumann algebras
as we'll see a bit later)
can be defined using a similar universal property!
The tensor product of Hilbert spaces
can however also be described directly:
\end{point}
\end{point}
\begin{point}{Definition}%
...
and~$y\in\scrK$.
\begin{point}{Proof}%
	\TODO{We use here that the Schur product
		of positive matrices
		is positive again.
		We should relate with with the proofs of 
\sref{product-states-are-positive}
and~\sref{cp-bilinear}
	}
