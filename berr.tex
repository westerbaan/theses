...
The lemma used in the proof is false. Instead, we can use
the reasoning from my master thesis: $x \mapsto x \ominus y$ is an order anti-automorphism
    of~$\{ x ;\ x \in E ;\ x \leq y \}$.
Hence it turns infima
    into suprema and vice versa.
As~$a \wedge b =
    ((a \ovee b) \ominus b) \wedge
    ((a \ovee b) \ominus a)$,
we know~$b \vee a$ exists
    and~$a \wedge b =
    ((a \ovee b) \ominus b) \wedge
    ((a \ovee b) \ominus a) =
    ((a \ovee b) \ominus (b \vee a)$,
     as desired.
\end{erratum}
