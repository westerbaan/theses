...
By the universal property of~$\xi_1$ again,
        ...
        Thus~$\vartheta_2$ is an isomorphism
            with~$\vartheta_2 \after \xi_2 = \xi_1$.
            It is the unique such isomorphism by the universal property of~$\xi_1$.
\item
Assume~$f\colon X \to Y$ is some map.
...
We will show that~$0$ has a left-adjoint using the universal mapping property.
...
By definition of map in~$\int \Pred_\square$,
