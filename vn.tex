...
algebra of bounded operators on some Hilbert space~$\scrH$,
and let~$x\in \scrH$.
Then the carrier of $\omega:= \left<x,(\,\cdot\,)x\right>|\scrA^\square$
is the projection onto~$\overline{\scrA x}$.
\begin{point}{Proof}%
	\TODO{...}
\end{point}
\end{point}
