...
\end{enumerate}
\end{point}
\begin{point}[central-separating]{Proposition}%
For a collection of np-functionals
on a von Neumann algebra,
the following are equivalent.
\begin{enumerate}
\item
...
\end{enumerate}
\begin{point}{Proof}%
\TODO{complete---might need the bicommutant theorem,
and in that case must be moved down}
\end{point}
\end{point}
\end{parsec}
