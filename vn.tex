...
\item
\TODO{ $\ketbra{0}{x_S}$ is u.w.-Cauchy, but not u.w.-convergent.}

\TODO{ Is a von Neumann algebra ultrastrongly complete? }
\end{enumerate}
\end{point}
\end{parsec}
%
...
and pick~$\alpha_0$
such that $\|T_\alpha-T_\beta\|_\omega \leq \frac{1}{3}\varepsilon$
...
\ +\ 
\bigl(\,
\sum_{n=N}^\infty \|(T-T_\alpha)x_n\|^2
\,\bigr)^{\nicefrac{1}{2}}
\end{equation*}
for any~$\beta$ and~$N$.
Now, first choose~$N$ 
large enough that the third term is below~$\frac{1}{3}\varepsilon$,
and then choose~$\beta\geq \alpha_0$ such that
the first term is below~$\frac{1}{3}\varepsilon$
(for choosen~$N$).
Then since~$\alpha,\beta\geq \alpha_0$
the second term will also be below~$\varepsilon$,
and so we get~$\|T-T_\alpha\|_\omega\leq \varepsilon$.
Hence~$(T_\alpha)_\alpha$ converges ultrastrongly to~$T$.\qed
\end{point}
