...
and  instead put the directed suprema and normal 
positive functionals
on center stage.
Nevertheless our treatment doesn't stray too far
...
(see~\sref{vn-complete}), which are perhaps novel observations).
This allows us to
define,
for example,
...
is ultrastrongly dense in~$(\scrB)_1$
(see~\sref{kaplansky}).
\item
