...
| `SEA` | 73 / 73 | 11,500 | complete; main theorem SEA 64 (every normal SEA is B ⊕ E_c ⊕ E_ac); SEA 16's JB/JBW sentence for all finite-dimensional and all special (JC/JW) algebras, exceptional infinite-dimensional open |
...
| `REC` | 136 / 136 | 17,500 | complete; REC 121 (V_A is a JB-algebra) proved outright, repairing the print's appeal to A–S 9.48; A–S (1.82) and REC 119 proved; **Theorems 102 and 103 with no named hypotheses** (`rec102_hypfree`, `rec103_hypfree`); 136 assumes only two JBW-intrinsic corollaries of verified literature results: an exceptional summand (from Hanche-Olsen–Størmer 7.2.7) and no four pairwise-exchangeable orthogonal idempotents in a purely exceptional JBW-algebra (from Shultz 1979 Thm 3.9) — `rec136_nofour_hypfree`; alternatively with a Jordan hom into the Albert algebra, `rec136_native_hypfree`; REC 104 refuted (sequential effectuses have irreducible scalars) |
