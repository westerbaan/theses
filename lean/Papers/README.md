...
| `REC` | 136 / 136 | 15,000 | complete; Theorems 102, 103 and 136 under named hypotheses (Alfsen–Shultz, Hanche-Olsen–Størmer, Shultz; the A–S 9.43/9.48 one is REC's own transplant, truth open); REC 104 refuted (sequential effectuses have irreducible scalars) |
