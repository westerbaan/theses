...
| 106I | `uniqueness_sequential_product_exists` | `A/Proc/Measurement.lean:9294` | 79 | 1/3 |
| 4XIII | `positive_2x2matrix_2` | `A/CStar/Basic.lean:403` | 67 | 1/2 |
...
| 23II | `sqrt_lemma_monotone` | `A/CStar/Positive.lean:8974` | 35 | 3/6 |
...
| `summable_diagTerm` | `Tensor.lean:7593`, `summable_diagTerm.hasSum` |
| `continuous_diagChi` | `Tensor.lean:7613`, `continuous_diagChi.comp hcont` |
