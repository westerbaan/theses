...
* `review-rec136.md` — break-it review of REC §6: all named hypotheses faithful (the A–S Lemma 4.4 label for REC 132 unverified offline); rec136 as printed; REC 127's zero-object refutation stands but is not an erratum; the triple-product swap is.
