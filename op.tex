...
\begin{parsec}%
\begin{point}%
We'll derive some basic facts about the invertible elements
in $C^*$-algebra,
that built up to the technicallt important result,
that if an element $a$ of a $C^*$-subalgebra~$\scrB$
of some (larger) $C^*$-algebra~$\scrA$
