...
when $I$ and~$J$ are Riesz ideals.
\TODO{Riesz decomposition theorem}
...
is not only maximal in the set of proper Riesz ideal,
but is also  maximal in the set of proper order ideals.
\begin{point}{Proof}%
...
is also a Riesz ideal by~\sref{}.
Hence  $I+(a)$ is a Riesz ideal by \TODO{}.
