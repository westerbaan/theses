...
Both chapters, or rather parts, can be read separetely
...
Both parts study the category of von Neumann algebras
    (with ncpsu-maps\footnote{%
        An abbreviation for \Define{n}ormal \Define{c}ompletely \Define{p}ositive contractive (ie.~\Define{s}ub\Define{u}nital) linear maps.} between them).
...
The first part of this thesis starts with a concrete question:
    ...
    a cornerstone in quantum theory,
...
But perhaps the most interesting by-catch of pondering the question,
...
Our results are interwoven to such a degree,
    that seperating them is difficult
    and, more importantly, detrimental to the clarity of presentation.
Thus we decided to write our theses as two consecutive volumes
...
Because of this clear division,
    a significant amount of Abraham's original work appears in my thesis
        and, vice versa, my work in his.
Of course, the large majority of the
        new results in each of our thesis is our own.
\end{point}
...
Page numbers have been replaced by the
    group numbers that appear on the spread.
...
First, there are colleagues who also study some category
