...
(see e.g.~\cite{jacobs2013block,rennela2015operator,furber2013kleisli}, 
	and~\cite{cho2016semantics} for an overiew)
...
which represents a ``quantum integer.''\footnote{Though
	...
	presheaves\cite{malherbe2013categorical},
...
especially since
this seems to be enough to describe quantum algorithms.\cite{nielsen2002quantum}
\end{point}
\begin{point}%
...
the notion of \emph{effectus}\cite{nd} had already
...
analysis, topology\cite{willard} and set theory\cite{devlin2012joy})
...
everything in its proper abstract (categorical\cite{maclane}) context
...
taking for example Kadison's characterization\cite{kadison1956}
...
of other topics 
with Sebastiaan Joosten,
Sam Staton, Robin Adams, Robin Kaarsgaard,
Sander Uijlen,
Robbert Krebbers,
Hans Maassen,
Bert Lindenhovius,
Frank Roumen, Joshua Moerman,
and others.
I'm especially honored to have been received
in Edinburgh by Chris Heunen \& Martti Karvonen,
and at the Mathematisches Forschungsinstitut Oberwolfach
by Jianchao Wu.
