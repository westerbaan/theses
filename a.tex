...
\noindent
\hfill{}
\href{https://arxiv.org/abs/1804.02203}{arXiv: 1804.02203}
\hfill{}
...
initially enrolled as a physics and astronomy student at 
the Radboud University in 2006, 
but he obtained a bachelor's degree in mathematics 
under supervision of prof.~dr.~H.P.~Barendregt (cum laude),
and a master's degree in mathematics 
supervised by prof.~dr.~A.C.M.~van Rooij (summa cum laude),
both in 2012.
His doctoral research started in 2013
with a study of (co)algebra under the guidance of dr.~A.~Silva,
and shifted 
in~2014
under the auspices of prof.~dr.~B.P.F.~Jacobs
to the material presented in this thesis.
From 2018 onwards he works as a postdoctoral researcher
at the digital security department.
\end{document}
