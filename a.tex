...
\begin{document}
Beware: this is not the most recent version my thesis,
but it is the version whose numbering is consistent with the first
preprint of my brother's thesis available at
\url{https://arxiv.org/abs/1803.01911v1}.

When my thesis is put on arXiv,
a renumbered version of my brother's thesis will appear there as well.

\hfill{} Bram, 2018-03-30
...
about the relation
between self-dual Hilbert $\scrA$-modules
and purity,
and the abstract theory of corners and filters
as you'll see in the next instalment of
