...
Wat is wiskunde? Volgens mij  niets anders dan een studie van de patronen
in de wereld om ons heen in de meest strenge en formele zin.
Door zich bewust, bijna komisch, blind te maken voor bijvoorbeeld
de `kern van waarheid' in een terloopse opmerking 
of de veelzijdigheid van een kwestie---zaken 
die een ander zo in het oog zouden springen---dwingt 
de wiskundige zichzelf uitdrukking
te geven aan meestal \'e\'en aspect van de werkelijkheid
...
niet alleen omdat we de meeste fenomenen daarvoor nog niet goed
genoeg begrijpen,
of omdat de wiskunde daar nog niet klaar voor is,
(of omdat het simpelweg niet praktisch is,)
maar vooral omdat het mes van de formele wiskunde te scherp snijdt.
...
bestand zijn.
Het is dan ook niet gek dat wiskunde
zich voornamelijk bezighoud met abstracte of ge\"idealiseerde 
objecten zoals getallen, vierkanten, cirkels, distributies,
tensoren en vari\"eteiten
in plaats van logistiek, akkers, hemellichamen, toekomstverwachtingen,
electrische velden en sterrenstelsels.

Het is wonderbaarlijk hoe behulpzaam
wiskunde kan zijn ondanks (of juist dankzij) haar
beperkingen:
...
schaakbordpartroon en de relevante coordinaten en afmetingen geef,) dan
kan ieder die bekend is met `inproducten' (vgl.~\sref{hilb-def})
en zich daartoe geroepen voelt
zonder moeite een computerprogramma schrijven dat
...
grijpt men ongetwijfeld het meeste terug
naar de cirkel (en de lijn);
en
bepaalde constanten ($2\pi$, $e$, $\varphi$, $\sqrt{2}$, \ldots) 
verschijnen vaker in formulen dan anderen.
Natuurlijk kan een nuttig wiskundig begrip 
ook slecht gebruikt worden: zoals het omschrijven van
een planeetbaan met een groot
aantal cirkels (`epicycles') in plaats van \'e\'en ellips.
Hier is zeker sprake van persoonlijke
voorkeur, conventie en willekeur---waarom gebruiken
we niet $2\pi=6,\!2831\dotsc$
als constante in plaats van
$\pi=3,\!1415\dotsc$, zie~\cite{palais2001pi}? 
Dat een wiskundig begrip (zoals epicycles)
in ongebruik geraakt is, wil niet zeggen
dat deze geen stijlvol herintreden kan maken:
de fourier reeks (eigenlijk oneindig veel epicycles)
geeft de ellips het nakijken!\footnote{Of toch niet,  \cite{mayer2010drawing}?}

Dit proefschrift gaat over zo'n bruikbaar wiskundig begrip,
...
de moderne computerarchitectuur te danken,
maar bijvoorbeeld ook de explosieve lenzen die in kernwapens gebruikt worden,
het afschrikwekkende \emph{mutual assured destruction}
en de numerieke weersvoorspelling.
De aanleiding voor zijn onderzoek naar von Neumann algebras
is de ontdekking dat grootheden van deeltjes
(zoals positie, momentum, energie) beter niet beschreven kunnen worden
als getal, maar als een \emph{operator}, een soort 
mogelijk oneindig grote tabel van complexe getallen
(waarin ook het effect van de meting van deze grootheid besloten ligt.)
Von Neumann bestudeerde deze operatoren eerst afzonderlijk,
maar later in groepjes, die hij \emph{ringen van operatoren}
noemde, maar nu bekend staan als von Neumann algebras.
Alledaagse getallen worden ook door wiskundigen gegroepeerd;
zo zijn er de gehele getallen, $\Z=\{\dotsc,-2,-1,0,1,2,\dotsc\}$,
de breuken, $\mathbb{Q}
=\{ \dotsc, -1/2,\dotsc 0, \dotsc 1/3,\dotsc  1/2,\dotsc,  1,\dotsc \}$,
paren van gehele getallen, 
$\Z \oplus \Z = \{ \dotsc\,(0,0),\, (0,1),\,\dotsc (1,0),(1,1),\dotsc \}$.

Deze operatoren vormen 
