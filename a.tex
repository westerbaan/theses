...
De `kern van waarheid' in een onnauwkeurige opmerking
zoals ``de helft van je eten ligt naast je bord!'' negeert
...
(zoals positie, momentum en energie) beter niet beschreven kunnen worden
door een getal, maar door een \emph{operator}.
Je zou je een operator voor kunnen proberen te stellen als een soort
mogelijk oneindig grote tabel van complexe getallen,
(maar als je de wiskundige definitie kent, \sref{bounded-linear-maps}, 
hoeft dit niet.)
Von Neumann bestudeerde deze operatoren eerst afzonderlijk,
en vanaf~1937 in speciale groepjes,
die hij \emph{ringen van operatoren} noemde,
maar nu bekend staan als von Neumann algebras.
