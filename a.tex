...
in de wereld om ons heen in de meest strenge en formele zin.
De wiskundige
maakt zich  bewust, bijna komisch, blind 
voor zaken die een ander zo in het oog zouden springen.
De bedoeling van een onnauwkeurige vraag
zoals ``wil je koffie of thee?''
negeert
de wiskundige bijvoorbeeld beroepsmatig
als het antwoord slechts ``ja'' is.
Maar hierdoor kan de wiskundige wel
...
soms begrijpen we het fenomeen daarvoor nog niet goed genoeg,
of is de benodigde wiskunde daarvoor nog niet ontwikkeld,
maar in de meeste gevallen snijdt
het mes van de formele wiskunde te scherp.
...
wat \emph{twee} is, dan weer wel.
Het is niet zozeer dat de wiskundige zich niet bezig zou willen houden
...
elektrische velden en sterrenstelsels, resp..
...
kan ieder die bekend is met `inproducten' (vgl.~\sref{hilb-def})
...
wil niet zeggen dat elk wiskundig begrip dit is.
Integendeel zelfs:
...
ook slecht gebruikt worden: zoals bijvoorbeeld het omschrijven van
de baan van een planeet met een groot
aantal cirkels (`epicykels') in plaats van \'e\'en ellips.
...
Het is niet eenvoudig om uit te leggen
 wat een Neumann algebra precies is, \sref{vna},
 maar 
...
voor een kwamtumcomputer omschreven
kunen worden door von Neumann algebras.
Zo wordt de klassieke bit (die~$0$ of~$1$ kan zijn)
voorgesteld door de von Neumann algebra ``$\C^2$''
en de kwantumbit (die een complexe combinatie van~$0$ of~$1$ is totdat
je haar meet)
...
Dit hangt natuurlijk af van de wijze van samenstelling:
...
De bewerking ``$\otimes$'' op von Neumann algebras
...
Meting is bijvoorbeeld zo'n process van een kwantumbit naar een klassieke bit.
Zulke processen worden in de wereld van von Neumann algebras
voorgesteld door ``ncpsu-afbeeldingen''
tussen von Neumann algebras.
Een van de hoofdresultaten van dit proefschrift
is een interpretatie voor deze `processen'-samenstelling,
de bewerking~$\limp$.
Dit is niet slechts een kwestie van de ncpsu-afbeeldingen
op een berg gooien---dat levert geen von Neumann algebra
en bovendien moet de interpretatie in bepaalde formele zogenaamde 
categorische
kaders passen,
wat de keuze sterk beperkt,
maar je ook dwingt om rekening te houden met alle complexe interacties
die deze twee systemen met elkaar kunnen hebben,
en---verrassend genoeg---met buitenstaande systemen.
De crux was niet te willen proberen de bewerking~$\limp$ 
(en daarmee deze interacties) 
direct te omschrijven,
maar het bestaan indirect aan te tonen
(zoals ik ook kan laten zien dat er een oudste persoon op aarde is,
zonder zijn of (waarschijnlijker) haar  naam ken.)
Voor een beperkte klasse van
von Neumann algebras, de hereditair atomsische, bleek een
directe omschrijven trouwens wel mogelijk (\sref{AstarhaB-concrete}).

Het tweede hoofdresultaat van dit proefschrift
is de vondst van een categorisch kader dat 
(in de context van von Neumann algebras) het process
van meting vastlegt (\sref{sqrt-axiom}).
Deze categorische kaders zijn zelf weer aan formele kaders gebonden, 
wat voorkomt dat dit een triviale zaak wordt.
Het probleem in dit geval was dat we lange tijd methode zagen
...
(ook wel \emph{contraposedness}, \sref{contraposed}):
...
De rest van dit proefschrift bestaat,
enigzins ongebruikelijk, 
uit een uitgebreide introductie
tot de benodigde reeds bestaande theorie
van $C^*$-algebras en von Neumann algebras.
In principe zou ieder die een bachelorgraad in de wiskunde heeft 
behaald deze tekst moeten kunnen begrijpen.
Niet alleen bestond
een geschikte introductie nog niet, maar het leek me ook goede kans 
om me nog verder te verdiepen in de theorie van von Neumann algebras.
Ik ontwikkel de gehele benodigde theorie inclusief 
bewijzen.  Op een groot aantal plekken wijk ik af van 
het gebruikelijke pad:
soms om de de tekst kort te houden, zo ontwijk ik de
theorie van Banach algebras volkomen;
maar meestal om te experimenteren met variaties,
zo gebruik ik Kadison's omschrijving
van von Neumann algebras om
de theorie te ontwikkelen (wat niet eerder gedaan is.)
