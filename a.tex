...
\vspace*{10em}
\begin{center}
{\large\sffamily\color{darkblue}#1:}
\end{center}
\begin{center}
...
\vspace{5em}
\begin{center}
{\large\sffamily\color{darkblue}#2:}
\end{center}
\begin{center}
Prof.~dr.~J.D.M.~\textsc{Maassen}\\
\vspace{.5em}
Prof.~dr.~P.~\textsc{Panangaden} (McGill University, Canada) \\
\vspace{.5em}
Prof.~dr.~P.~\textsc{Selinger} (Dalhousie University, Canada) \\
\vspace{.5em}
Dr.~C.~\textsc{Heunen} (University of Edinburgh, #3)\\
\vspace{.5em}
...
\achterkanttitelpagina{Promotor}{Manuscriptcommissie}{Schotland}
...
to be defended in public on \textbf{Tuesday, May 14, 2019}\\
at \textbf{10.30 hours}}{by}{Born on August 30, 1988\\
in Nijmegen (The Netherlands)}

\achterkanttitelpagina{Supervisor}{Doctoral Thesis Committee}{Scotland}
