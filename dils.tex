...
\begin{point}{Definition}%
    ...
    $\Phi \subseteq X\times X$ called \Define{entourages}
    ...
    \item
        ...
        \emph{and}
        \item
        if~$\varepsilon \subseteq \delta \in \Phi$,
...
With this in mind, the first axiom states every point is arbitrarily close
    to itself.
