...
For Stinespring's dilation these maps are always of the form~$\ad_V$,
    but for Paschke's dilation different maps may appear ---
...
We already encountered Hilbert C$^*$-modules
    ...
    in my twin bother's thesis \cite{bram}.
...
We want to show~$t = 0$.
As~$c$ is injective by~\sref{dils-filters-injective} $ptp = 0$.
