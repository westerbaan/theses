...
\begin{point}%
    We are ready to state the more general universal property
        that Stinepspring's dilation satisfies,
        which we will allow use to generalize it to arbitrary ncp-maps.
\end{point}
\parpic[r]{
...
\begin{point}{Uniqueness}%
    ...
    Similar to the uniqueness proof in \sref{dils-univ-stinespring},
    we compute
