...
\begin{point}[dils-dfn-uniformity]{Definition}%
    ...
    \item
        ...
        \end{inparaenum}
    \item
        The diagonal is an entourage: $\{(x,x);\ x\in X\} \in \Phi$.
    \item
...
\begin{parsec}%
\begin{point}%
It is well known that a uniform space~$X$ can be completed
    by embedding it in a uniform space of equivalence classes
    of Cauchy nets~$C$,
...
\begin{point}{Proposition}%
    ...
    Furthermore, for every uniformly continuous~$f\colon X \to Y$
        into a bounded complete uniform space~$Y$,
...
By definition we can find~$\alpha_\varepsilon \in I$
    ...
    we have~$x_\alpha \mathrel{\nicefrac{\varepsilon}{2}} x_\beta$.
...
The net~$(x_{\alpha_{\varepsilon}})_{\varepsilon\in\Phi}$
    is a fast and Cauchy:
