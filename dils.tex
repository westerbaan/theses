...
We start the second part of this chapter
    ...
    to the same question about the Stinespring representation.
...
The main result of the last part of this chapter
    ...
    we show that an ncp-map~$\varphi$ is pure in the sense of \TODO{}
    if and only if the map on the left-hand side of
    the Paschke dilation of~$\varphi$ is surjective.
This is a bridge to the final part of the next chapter,
    in which we prove that these pure maps have a~$\dagger$-structure,
...
The kernel of~$\varrho$ is~$z \scrA$ for some central projection~$z$.  \TODO{}
