...
These~$V_i$ are called the \Define{Kraus operators}.
...
The modification is mostly straight-forward, except for the following lemma.
\end{point}
...
\begin{point}{Exercise}%
    The statement of this universal property of Stinespring
