            ...
            \item $X$ has an \Define{orthonormal basis}
                ...
                \begin{enumerate}
                    ...
                    \item for each~$x \in X$ we have
                        \begin{equation*}
                        x = \sum_{e \in E} e\left<x, e\right>,
                        \end{equation*}
...
Von Neumann algebras are ultrastrong complete, see \TODO{}.
Define~$\tau(y) = (\uslim_\alpha \left<y, x_\alpha\right>)^*$.
As addition and multiplication by a fixed element
are ultrastrongly continuous (see \TODO{})
    $\tau$ is~$\scrB$-linear.
